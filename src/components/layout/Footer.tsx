    ...
    <footer className="bg-steel-dark border-t border-border">
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-muted-foreground text-sm">
                ...
                <a href="mailto:rsnirmiti@gmail.com" className="hover:text-primary transition-colors">rsnirmiti@gmail.com</a>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © {currentYear} NIRMITI ASSOCIATES. All rights reserved.
          </p>
