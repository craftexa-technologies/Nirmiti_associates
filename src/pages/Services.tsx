...
const galleryImages = [
  { src: g1, alt: "Project 1" },
  { src: g2, alt: "Project 2" },
  { src: g3, alt: "Project 3" },
  { src: g4, alt: "Project 4" },
  { src: g5, alt: "Project 5" },
  { src: g6, alt: "Project 6" },
  { src: g7, alt: "Project 7" },
  { src: g8, alt: "Project 8" },
  { src: g9, alt: "Project 9" },
  { src: g10, alt: "Project 10" },
  { src: g11, alt: "Project 11" },
  { src: g12, alt: "Project 12" },
];
              ...
              <ScrollReveal key={service.title} animation="fade-up" delay={index * 0.1}>
                <div className="bg-card border border-border rounded-lg overflow-hidden hover:border-primary/50 transition-colors h-full group">
                  <div className="aspect-[16/10] overflow-hidden relative">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent dark:from-card/80 dark:to-transparent" />
          ...
          <ScrollReveal animation="fade-up">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Browse our completed projects and see the quality and craftsmanship we bring to every build.
              </p>
            </div>
          </ScrollReveal>
                ...
                <CarouselContent className="-ml-4">
                  {galleryImages.map((image, index) => (
                    <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                      <div className="overflow-hidden rounded-xl border border-border bg-card aspect-[4/3] w-full">
                        <img
                          src={image.src}
                          alt={image.alt}
